...
export default withMermaid(
  defineConfig({
    ...
    lang: 'es-ES',
    base: '/teacher-brain-docs/',
    lastUpdated: true,
    cleanUrls: true,
    markdown: { lineNumbers: true },
    head: [
      ['link', { rel: 'icon', type: 'image/svg+xml', href: '/teacher-brain-docs/favicon.svg' }],
      ['link', { rel: 'icon', type: 'image/png', href: '/teacher-brain-docs/favicon-32.png', sizes: '32x32' }],
      ['link', { rel: 'apple-touch-icon', href: '/teacher-brain-docs/apple-touch-icon.png', sizes: '180x180' }],
    ...
    themeConfig: {
      logo: '/teacher-brain-docs/teacher-brain.png',
